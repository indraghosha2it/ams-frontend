...
// src/app/staff/viewClients/page.js - Fixed with react-hot-toast
'use client';
...
export default function StaffViewClientsPage() {
  ...
  // Sample data for demo with new fields
  const getSampleClients = () => {
    return [
      {
        _id: '1',
      ...
      },
      {
        ...
        email: 'james@example.com',
        phone: '(555) 567-8901',
        dateOfBirth: '1988-11-18T00:00:00.000Z',
        gender: 'male',
                            ...
                            <div className="space-y-2">
                              ...
                              {client.gender ? (
                                <div className="flex items-center text-gray-600 dark:text-gray-400">
                                  ...
                                  <span className="text-sm capitalize">{formatGender(client.gender)}</span>
                                </div>
                              ) : (
                                <div className="flex items-center text-gray-500 dark:text-gray-500 text-sm">
                                  <UserCircle className="size-4 mr-2" />
