// src/app/staff/settings/page.js
'use client';
...
export default function StaffSettingsPage() {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      if (currentUser.role !== 'staff') {
        toast.error('Only staff can access this page');
      ...
      if (error.response) {
        ...
        if (error.response.status === 404) {
          console.log('Staff profile endpoint returned 404, using local storage');
          ...
          if (localUser) {
            ...
            toast.error('Staff profile endpoint not configured yet');
            return;
          }
        }
      }
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-3 mb-2">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Manage your staff profile and security settings
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className={`px-3 py-1 rounded-full text-sm font-medium ${
              ...
              {userData?.isActive ? 'Active Staff Account' : 'Account Inactive'}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6 border border-blue-100 dark:border-blue-800/30">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">
                Staff ID: {userData?._id?.substring(0, 8)}... • Member since {formatDate(userData?.createdAt).split(',')[0]}
              </p>
            </div>
          </div>
          ...
          <div className="md:ml-auto flex flex-wrap gap-3">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-700">
              ...
              <div className="font-medium text-teal-600 dark:text-teal-400">
                {userData?.role ? userData.role.charAt(0).toUpperCase() + userData.role.slice(1) : 'Staff'}
              </div>
            </div>
            
            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-700">
              <div className="text-xs text-gray-500 dark:text-gray-400">Access Level</div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center">
                <Briefcase className="size-6 mr-3 text-teal-600 dark:text-teal-400" />
                Staff Account Information
              </h2>
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                View your staff account details and permissions
              </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-6">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Unique identifier for your staff account
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-6">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      {userData?.isActive ? 'Staff account is active' : 'Staff account is currently inactive'}
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-6">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Staff member with assigned permissions
                    </p>
                  </div>
                </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/10 dark:to-purple-900/10 rounded-lg p-6 border border-blue-100 dark:border-blue-800/30">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 ml-14">
                          Contact number for appointment notifications
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      <div className="absolute left-3 top-3 bg-blue-100 dark:bg-blue-900/30 p-2 rounded-lg">
                        <Phone className="size-5 text-blue-600 dark:text-blue-400" />
                      </div>
                    </div>
                    {errors.phone && (
        ...
        {activeTab === 'security' && (
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                Update your staff password for security
              </p>
            </div>
