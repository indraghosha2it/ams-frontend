...
const PastAppointments = () => {
  ...
  const getAppointmentCardClass = (status) => {
    switch (status) {
      case 'confirmed':
        return 'border-l-4 border-emerald-500 bg-gradient-to-r from-emerald-50/50 to-white';
      case 'cancelled':
        return 'border-l-4 border-red-500 bg-gradient-to-r from-red-50/50 to-white';
      case 'pending':
        return 'border-l-4 border-amber-500 bg-gradient-to-r from-amber-50/50 to-white';
      default:
        return 'border-l-4 border-slate-300 bg-white';
    }
  };
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={fetchAppointments}
                className="px-4 py-2.5 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-all flex items-center gap-2 font-medium"
              >
                <History className="w-4 h-4" />
                Refresh History
              </button>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start gap-4">
                          {/* Date Badge */}
                          <div className={`min-w-[100px] text-center ${
                            appointment.status === 'confirmed' ? 'bg-emerald-100' :
                            appointment.status === 'cancelled' ? 'bg-red-100' :
                      ...
                      <div className="flex-1">
                        <div className="space-y-3">
                          ...
                          {/* Action Buttons */}
                          <div className="flex flex-wrap gap-2 pt-2">
                            {/* Rate Appointment Button (for confirmed appointments only) */}
                            ...
                            {/* Download Prescription Button (for confirmed appointments only) */}
                            {appointment.status === 'confirmed' && (
                              <button
                                onClick={() => handleDownloadPrescription(appointment)}
                                className="px-3 py-1.5 text-sm text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg transition flex items-center gap-1"
                            ...
                            {/* Book Follow-up Button (for confirmed appointments only) */}
                            {appointment.status === 'confirmed' && (
                              <button
                                onClick={() => handleBookFollowUp(appointment)}
                                className="px-3 py-1.5 text-sm text-emerald-600 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition flex items-center gap-1"
